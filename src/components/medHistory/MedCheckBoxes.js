...
export const MedCheckBoxes = () => {
   ...
   const handleSaveClick = (event) => { //function to save the updated Medical History
    ...
    fetchMedicalHistory(`/${medHistory.id}`, putOption(medHistory))  //fetch call with PUT option
    .then((historyUpdate)=> {
